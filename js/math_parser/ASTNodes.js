...
export class NumberNode extends MathNode {
  ...
  createCode(context) { return this.CodeBuilder.push(this.value, this.loc); }
  ...
  createCode(context) {
    ...
    for (let i = 0; i < this.#rows.length; i++) {
      ...
      for (let j = 0; j < row.length; j++) {
        const node = row[j];
        builder.pppend(node.createCode(context)).topToLoc(node.loc);
      }
    }
...
export class IsOpNode extends MathNode {
  ...
  createCode(context) { return this.CodeBuilder.is(this.argument.createCode(context), this.targetType, this.loc); }
...
export class CastOpNode extends MathNode {
  ...
  *getChildren() {
  ...
  createCode(context) { return this.CodeBuilder.cast(this.argument.createCode(context), this.targetType, this.loc); }
}
regAST(CastOpNode);
...
export class UnaryOpNodePlus extends UnaryOpNode {
  ...
  createCode(context) { return this.CodeBuilder.plus(this.argument.createCode(context), this.loc); }
}
...
export class UnaryOpNodeMinus extends UnaryOpNode {
  ...
  createCode(context) { return this.CodeBuilder.neg(this.argument.createCode(context), this.loc); }
}
...
export class UnaryOpNodeNot extends UnaryOpNode {
  ...
  createCode(context) { return this.CodeBuilder.not(this.argument.createCode(context), this.loc); }
...
export class AddNode extends BinaryOpNode {
  ...
  createCode(context) { return this.CodeBuilder.add(this.left.createCode(context), this.right.createCode(context), this.loc); }
...
export class OrNode extends BinaryOpNode {
  ...
  createCode(context) { return this.CodeBuilder.or(this.left.createCode(context), this.right.createCode(context), this.loc); }
...
export class XorNode extends BinaryOpNode {
  ...
  createCode(context) { return this.CodeBuilder.xor(this.left.createCode(context), this.right.createCode(context), this.loc); }
...
export class AndNode extends BinaryOpNode {
  ...
  createCode(context) { return this.CodeBuilder.and(this.left.createCode(context), this.right.createCode(context), this.loc); }
...
export class EquNode extends BinaryOpNode {
  ...
  createCode(context) { return this.CodeBuilder.equ(this.left.createCode(context), this.right.createCode(context), this.loc); }
...
export class NotEquNode extends BinaryOpNode {
  ...
  createCode(context) { return this.CodeBuilder.notEqu(this.left.createCode(context), this.right.createCode(context), this.loc); }
...
export class LtNode extends BinaryOpNode {
  ...
  createCode(context) { return this.CodeBuilder.lt(this.left.createCode(context), this.right.createCode(context), this.loc); }
...
export class GtNode extends BinaryOpNode {
  ...
  createCode(context) { return this.CodeBuilder.gt(this.left.createCode(context), this.right.createCode(context), this.loc); }
...
export class LteNode extends BinaryOpNode {
  ...
  createCode(context) { return this.CodeBuilder.lte(this.left.createCode(context), this.right.createCode(context), this.loc); }
...
export class GteNode extends BinaryOpNode {
  ...
  createCode(context) { return this.CodeBuilder.gte(this.left.createCode(context), this.right.createCode(context), this.loc); }
...
export class SubNode extends StrictRightBinNode {
  ...
  createCode(context) { return this.CodeBuilder.sub(this.left.createCode(context), this.right.createCode(context), this.loc); }
...
export class MulNode extends BinaryOpNode {
  ...
  createCode(context) { return this.CodeBuilder.mul(this.left.createCode(context), this.right.createCode(context), this.loc); }
...
export class DivNode extends StrictRightBinNode {
  ...
  createCode(context) { return this.CodeBuilder.div(this.left.createCode(context), this.right.createCode(context), this.loc); }
...
export class ModNode extends StrictRightBinNode {
  ...
  createCode(context) { return this.CodeBuilder.mod(this.left.createCode(context), this.right.createCode(context), this.loc); }
...
export class PowNode extends BinaryOpNode {
  ...
  createCode(context) { return this.CodeBuilder.pow(this.left.createCode(context), this.right.createCode(context), this.loc); }
